...
class TransactionService {
    ...
    */
    func chargeBank(request : ApiRequest) -> Observable<ApiResponse<VerifyOtp>> {
    ...
    */
    func enrollBankOtp(request : ApiRequest) -> Observable<ApiResponse<VerifyOtp>> {
    ...
    /*
        register customer phone for otp
    */
    func enrollCardOtp(request : ApiRequest) -> Observable<ApiResponse<VerifyOtp>> {
